...
def test_adult_data():
	...
	# K=np.dot(x_train,np.transpose(x_train))
	sample=kdpp.kDPPSampleMCMC(x_train,1000,0.01)
	# t1=x_control_train["sex"].astype(int)
	# sample = pdpp.PartitionDPPSampleMCMC(K,[500,500],t1,0.01)

	x_train=x_train[sample,:]
	y_train=y_train[sample]
	t=x_control_train["sex"]
	t=t[sample]
	x_control_train["sex"]=t
